(function () {
    ...
    function EChartsCtrl($scope, $timeout) {
        ...
        $scope.boxplot1 = {}; // echarts.dataTool is undefined, probably needs other module
